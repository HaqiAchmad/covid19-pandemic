 ...
 * @since 2020-11-25
 */
public class GejalaCovid extends javax.swing.JFrame {
    ...
    public GejalaCovid() {
        ...
        this.btnGejala.setBackground(new Color(22,108,190));
        ...
        */
        ...
        JButton[] btns = new JButton[]{this.btnBeranda, this.btnApaCovid, this.btnBahaya, this.btnPencegahan, this.btnPenanganan, this.btnCovidDunia, this.btnCovidIndo, this.btnTentangApp};
            ...
            public void run(){
                try{
                    ...
                    while(visible){
                        ...
                        System.out.println("Loop in Window GejalaCovid=?OK");
                    }                    
    ...
    private void initComponents() {
        ...
        lblTop.setText("Gejala Covid-19");
    ...
    private void lblPhotoProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblPhotoProfileMouseClicked
        ...
        InformasiAkun infoAkun = new InformasiAkun(InformasiAkun.GEJALA_COVID);
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        visible = false;
        acc.closeConnection();
        System.out.println("Menutup Window GejalaCovid");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GejalaCovid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
