 ...
 * @since 2020-11-25
 */
public class BahayaCovid extends javax.swing.JFrame {
    ...
    public BahayaCovid() {
        ...
        this.btnBahaya.setBackground(new Color(22,108,190));
        ...
        */
        ...
        JButton[] btns = new JButton[]{this.btnBeranda, this.btnApaCovid, this.btnGejala, this.btnPencegahan, this.btnPenanganan, this.btnCovidDunia, this.btnCovidIndo, this.btnTentangApp};
            ...
            public void run(){
                try{
                    ...
                    while(visible){
                        ...
                        System.out.println("Loop in Window BahayaCovid=?OK");
                    }                    
    ...
    private void initComponents() {
        ...
        lblTop.setText("Bahaya Covid-19");
    ...
    private void lblPhotoProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblPhotoProfileMouseClicked
        ...
        InformasiAkun infoAkun = new InformasiAkun(InformasiAkun.BAHAYA_COVID);
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        visible = false;
        acc.closeConnection();
        System.out.println("Menutup Window BahayaCovid");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BahayaCovid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
