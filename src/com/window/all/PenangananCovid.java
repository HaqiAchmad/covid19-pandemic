 ...
 * @since 2020-11-25
 */
public class PenangananCovid extends javax.swing.JFrame {
    ...
    public PenangananCovid() {
        ...
        this.btnPenanganan.setBackground(new Color(22,108,190));
        ...
        */
        ...
        JButton[] btns = new JButton[]{this.btnBeranda, this.btnApaCovid, this.btnGejala, this.btnBahaya, this.btnPencegahan, this.btnCovidDunia, this.btnCovidIndo, this.btnTentangApp};
            ...
            public void run(){
                try{
                    ...
                    while(visible){
                        ...
                        System.out.println("Loop in Window PenangananCovid=?OK");
                    }                    
    ...
    private void initComponents() {
        ...
        lblTop.setText("Penanganan Covid-19");
    ...
    private void lblPhotoProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblPhotoProfileMouseClicked
        ...
        InformasiAkun infoAkun = new InformasiAkun(InformasiAkun.PENANGANAN_COVID);
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        visible = false;
        acc.closeConnection();
        System.out.println("Menutup Window PenangananCovid");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PenangananCovid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
