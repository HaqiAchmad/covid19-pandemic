 ...
 * @since 2020-11-25
 */
public class ApaCovid extends javax.swing.JFrame {
    ...
    public ApaCovid() {
        ...
        this.btnApaCovid.setBackground(new Color(22,108,190));
        ...
        */
        ...
        JButton[] btns = new JButton[]{this.btnBeranda, this.btnGejala, this.btnBahaya, this.btnPencegahan, this.btnPenanganan, this.btnCovidDunia, this.btnCovidIndo, this.btnTentangApp};
            ...
            public void run(){
                try{
                    ...
                    while(visible){
                        ...
                        System.out.println("Loop in Window ApaCovid=?OK");
                    }                    
    ...
    private void initComponents() {
        ...
        lblTop.setText("Apa Itu Covid-19");
    ...
    private void formWindowClosed(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowClosed
        visible = false;
        acc.closeConnection();
        System.out.println("Menutup Window ApaCovid");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApaCovid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
